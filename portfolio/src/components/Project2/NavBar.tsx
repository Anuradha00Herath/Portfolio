  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-gray-900 bg-opacity-80 text-white z-20 shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            ...
            <Link href="/Projects2" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                Overview
              </Link>
      ...
      <div className="md:hidden" id="mobile-menu">
        ...
        <Link href="/Projects2" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
            Overview
          </Link>
